...
Pod::Spec.new do |s|
  ...
  # s.screenshots  = "https://raw.githubusercontent.com/TracyYanghandsome/YSSegmentedControl/master/demo.gif"
  ...
  # Or just: s.author    = "TracyYanghandsome"
  # s.authors            = { "TracyYanghandsome" => "2224202043@qq.com" }
  # s.social_media_url   = "http://twitter.com/TracyYanghandsome"
